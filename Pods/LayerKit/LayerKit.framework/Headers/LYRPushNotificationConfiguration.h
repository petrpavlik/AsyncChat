 ...
 */
@property (copy, nonatomic) NSDictionary *apns;
...
/**
 ...
 @discussion This property should only be set in a default configuration.  Setting this property in a per recipient configuration raises an exception.
 */
@property (copy, nonatomic) NSArray *alertLocalizationArguments;

/**
 @abstract If specified, the system displays an alert that includes the Close and View buttons.
 @discussion This property should only be set in a default configuration.  Setting this property in a per recipient configuration raises an exception.
 */
@property (copy, nonatomic) NSString *actionLocalizationKey;
 ...
 */
- (void)setPushConfiguration:(LYRPushNotificationConfiguration *)configuration forParticipant:(NSString *)participantIdentifier;
